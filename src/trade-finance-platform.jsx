      ...
      <div style={{ flex: "1 1 280px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {trade.state === "Funded" && (
          <div style={{ background: "#fff", borderRadius: 10, border: "1px solid #E8ECF0", padding: 20 }}>
            ...
            <button style={{ width: "100%", padding: 12, background: "#1565C0", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 700, cursor: "pointer", marginBottom: 8 }}>Trigger Release (Multisig)</button>
        ...
        {trade.state === "Created" && (
          <div style={{ background: "#fff", borderRadius: 10, border: "1px solid #E8ECF0", padding: 20 }}>
            <h3 style={{ margin: "0 0 14px", fontSize: 14, color: "#1B2A4A", fontWeight: 700 }}>Actions</h3>
            <button style={{ width: "100%", padding: 12, background: "#1B2A4A", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 700, cursor: "pointer", marginBottom: 8 }}>Deploy Escrow Contract</button>
            <button style={{ width: "100%", padding: 12, background: "#fff", color: "#C62828", border: "1px solid #E57373", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>Cancel Trade</button>
          </div>
        )}
      </div>
...
export default function App() {
  ...
  const renderPage = () => {
    ...
    if (page === "trades" && selectedTrade) return <TradeDetailPage trade={selectedTrade} onBack={() => setSelectedTrade(null)} />;
    switch (page) {
  ...
  return (<div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Inter', -apple-system, sans-serif", background: "#F4F6F9" }}>
    ...
    <div style={{ width: 220, background: "#1B2A4A", padding: "24px 0", display: "flex", flexDirection: "column", flexShrink: 0 }}>
      ...
      <div style={{ marginTop: "auto", padding: "16px 20px", borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        ...
        <div style={{ fontSize: 12, color: "rgba(255,255,255,0.7)", marginTop: 4, display: "flex", alignItems: "center", gap: 6 }}><span style={{ width: 6, height: 6, borderRadius: "50%", background: "#81C784", display: "inline-block" }} />Arbitrum One</div>
